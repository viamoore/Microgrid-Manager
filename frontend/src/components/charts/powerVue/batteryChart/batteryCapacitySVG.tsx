...
const BatteryCapacitySVG: React.FC<batteryCapacitySVGProps> = (props) => {
  ...
  const animateProjectedArc = useCallback(
    (
      startPercentage: number,
      endPercentage: number,
      animateArc: d3.Selection<
        SVGPathElement,
      ...
      animateArc
        ...
        .on("end", () =>
          animateProjectedArc(startPercentage, endPercentage, animateArc),
        );
    },
  ...
  const animateProjectedArcReverse = useCallback(
    (
      startPercentage: number,
      endPercentage: number,
      animateArc: d3.Selection<
  ...
  useEffect(() => {
    ...
    const svg = d3
      ...
      .attr(
        "style",
        "width: 100%; height: 100%; overflow: visible; font: 10px sans-serif; padding: 0px;",
      );
